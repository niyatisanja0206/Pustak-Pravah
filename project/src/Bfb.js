...
//       indexes.push(BookData.indexOf(book));
//     });
...
//     const filteredIndex = filteredIndexes[index];
//     const curProduct = BookData[filteredIndex];
...
//       filtered = filtered.filter(book => book.pub === publicationFilter);
//     }
...
//                   <button className="bfbbutton" onClick={() => addToCart(index)}>Add to Cart</button>
//                 </div>
//               </div>
//             </div>
//           ))}
